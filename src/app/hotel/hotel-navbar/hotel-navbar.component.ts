...
export class HotelNavbarComponent {
  ...
  navigationTabs: NavigationTab[] = [
    { id: 'add-meal', label: 'Add Meal', icon: 'add-meal', notifications: 0 },
    { id: 'history', label: 'History', icon: 'history', notifications: 0 },
    { id: 'ngo', label: 'Listed NGO', icon: 'ngo', notifications: 3 },
    { id: 'orders', label: 'View Order', icon: 'orders', notifications: 5 }
  ];
  ...
  private navigateUser(value: string) {
    switch (value) {
      ...
      case 'ngo':
        ...
        this.router.navigate(['./hotel/listed-ngo']);
        break;
      case 'orders':
        console.log('Navigate to View ordder');
        this.router.navigate(['./hotel/view-order']);
        break;
      default:
